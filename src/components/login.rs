...
pub fn discord_button_component() -> Html {
    html! {
        <>
            <a href="https://discord.com/api/oauth2/authorize?client_id=1210617983534112868&response_type=code&redirect_uri=https%3A%2F%2Fjackcat13.github.io%2Faptar%2F%23%2F&scope=identify+guilds+gdm.join+messages.read+applications.commands+activities.read+applications.commands.permissions.update+guilds.join+activities.write+dm_channels.read+guilds.members.read+connections+webhook.incoming+applications.builds.read+applications.entitlements+role_connections.write+relationships.read">
                <button
                    type="button"
